                    ...
                    <div class="row">
                        <div class="card shadow mb-4 col-sm-12">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Caretakers</h6><br>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                                <a class="dropdown-item view-teacher" href="<?php echo base_url();?>dashboard/editcaretaker/<?=$one['id'];?>">Edit</a>
                                                                <a class="dropdown-item delete-teacher" href="<?php echo base_url();?>dashboard/deletecaretaker/<?=$one['id'];?>">Delete</a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
